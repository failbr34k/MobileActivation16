...
/*!
 ...
 @abstract Returns a copy of a  system key.
 
 @param keyType Type of the requested system key.
 @param error An optional pointer to a CFErrorRef. This value is set if an error occured.
 
 @result On success of a SecKeyRef containing the requested key is returned, on failure it returns NILL.
 */
SecKeyRef SecKeyCopySystemKey(int keyType, CFErrorRef* error)
__OSX_AVAILABLE(12.0) __IOS_AVAILABLE(15.0);
